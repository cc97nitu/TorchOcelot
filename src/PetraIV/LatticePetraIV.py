...
from OcelotMinimal.cpbd.elements import *
...
class PetraIVLattice(Lattice):
    def __init__(self):
        # get element list
        elementList = get_lattice()

        super().__init__(elementList)
        return
...
if __name__ == "__main__":
    ...
    # create model
    model = SecondOrderModel(lattice, dim=6)
