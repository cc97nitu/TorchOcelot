...
class SIS18_Cell_minimal(MagneticLattice):
    """SIS18 multiturn cell consisting of dipoles and quadrupoles."""
    def __init__(self, nPasses: int = 1):
        ...
        super(SIS18_Cell_minimal, self).__init__(lattice, method=method)
